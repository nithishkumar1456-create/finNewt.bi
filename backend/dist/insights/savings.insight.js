...
exports.analyzeSavings = void 0;
const prisma_1 = require("../database/prisma");
const analyzeSavings = async (userId) => {
    const insights = [];
    const goals = await prisma_1.prisma.goal.findMany({ where: { userId, status: 'active' } });
...
exports.analyzeSavings = analyzeSavings;
